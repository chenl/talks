...
* chen@rotemlevy.name 00:25 (1:30)
...
* Testing is important 00:20 (1:45)
...
* So you want to learn you a unit-test 00:10 (1:10)
...
* Unit testing is complicated 1:30 (4:15)
...
** But we also need to patch print 0:15
...
* One step on a long journey 0:50 (5:50)
