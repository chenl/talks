...
* (1:30) — The real world is complicated
...
#+END_SRC
** (2:00) — We can tell Lulu what to do
#+NAME: code_PUPPY0
#+BEGIN_SRC python
...
** (0:15) — Go only when the light is green
...
** (0:15) — But also use your common sense
